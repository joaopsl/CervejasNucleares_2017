...
/* Generated from ../O.Common/BeerPiIOC.dbd */
...
int BeerPiIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/pi/BeerGit/CervejasNucleares_2017/RPi";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"BeerPiIOC_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    BeerPiIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
